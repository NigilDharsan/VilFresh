            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  "Farmer Details",
                  style: TextStyle(
                      fontWeight: FontWeight.w600, fontSize: 25, color: green2),
                ),
              ),
              //FARMER IMAGE
              Row(
                ...
                children: [
                  _farmerImg(context,
                      FarmerImg: widget.aboutFarmerData?[0].farmerImage ?? ""),
                  _farmerImg(context,
                      FarmerImg: widget.aboutFarmerData?[0].farmerImage ?? ""),
                ],
              ),
              ...
              Center(
                  child: Text(
                widget.aboutFarmerData?[0].farmerName ?? "",
                style: const TextStyle(
                    fontWeight: FontWeight.w700, fontSize: 22, color: green1),
              )),
              const SizedBox(
                height: 20,
              ),
              Text(
                widget.aboutFarmerData?[0].aboutFarmer ?? "",
                style: const TextStyle(color: Colors.black, fontSize: 16),
              ),
              const SizedBox(
                height: 20,
              ),
              SizedBox(height: 220, child: _FarmerRelatedList()),
              const SizedBox(
                height: 50,
              ),
            ],
...
Widget _farmerImg(context, {required String FarmerImg}) {
  return Container(
    ...
    child: buildImage(FarmerImg,
        border: const Radius.circular(20), fit: BoxFit.cover),
  );
}
