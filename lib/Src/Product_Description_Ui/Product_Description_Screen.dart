...
class Product_Description_Screen extends StatefulWidget {
  ...
  @override
  State<Product_Description_Screen> createState() => _Product_Description_ScreenState();
}

class _Product_Description_ScreenState extends State<Product_Description_Screen> {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Also known as:",style: Textfield_Style2,),
              ),
              Text("Ananas comosus",style: contentT,),
              //Seasonality
              Padding(
                padding: const EdgeInsets.only(top: 15,),
                child: Text("Seasonality:",style: Textfield_Style2,),
              ),
              Text("Round the year",style: contentT,),
              //BASIC INFORMATION
              Padding(
                padding: const EdgeInsets.only(top: 15,),
                child: Text("Seasonality:",style: Textfield_Style2,),
