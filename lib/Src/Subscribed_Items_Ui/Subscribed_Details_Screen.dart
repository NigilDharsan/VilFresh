...
class Subscribed_Details_Screen extends StatefulWidget {
  const Subscribed_Details_Screen({super.key});

  @override
  State<Subscribed_Details_Screen> createState() => _Subscribed_Details_ScreenState();
}

class _Subscribed_Details_ScreenState extends State<Subscribed_Details_Screen> {
  // Use a list of lists to store the morning and evening values
  List<List<int>> _data = List.generate(6, (index) => [0, 0]);
