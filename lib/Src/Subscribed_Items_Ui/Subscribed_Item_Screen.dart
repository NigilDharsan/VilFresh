...
class Subscribed_Item_Screen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Subscribed_Item_Screen> createState() =>
      _Subscribed_Item_ScreenState();
}

class _Subscribed_Item_ScreenState
    extends ConsumerState<Subscribed_Item_Screen> {
  @override
  void initState() {
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    data?.data?[index].variantName ?? "",
                                    style: subscribedHT,
                                  ),
                                  const SizedBox(height: 5),
                                  Text(
                                    "${data?.data?[index].fromDate} - ${data?.data?[index].toDate}",
                                    style: subscribedHT,
                                  ),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
