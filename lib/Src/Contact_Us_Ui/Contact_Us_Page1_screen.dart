...
class Contact_Us_Page1_Screen extends StatefulWidget {
  ...
  @override
  State<Contact_Us_Page1_Screen> createState() =>
      _Contact_Us_Page1_ScreenState();
}
...
Widget ratingstar() {
  return SizedBox(height: 45, width: 45, child: ImgPathPng('rating.png'));
}
