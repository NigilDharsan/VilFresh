  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Daily Subscription",style: TextStyle(fontWeight: FontWeight.w700,fontSize: 22,color: green2),),
      ),
      body: SingleChildScrollView(
        child: Padding(
          padding: const EdgeInsets.only(left: 20,right: 20),
          child:_dailySubscriptionList(),
        ),
      ),
    );
  }
  Widget _dailySubscriptionList(){
      ...
      itemBuilder: (BuildContext context, int index) {
        return Column(
          children: [
            Row(
              children: [
                Image.asset("lib/assets/glassmilk.png",height: 150,width: 150,),
                Spacer(),
                Column(
                  children: [
                    Text("Onion",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w700,color: green2),),
                    Container(
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(5),
                          color: Colors.green.shade100
                      ),
                      child: Text("      Buy Once     ",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: green2),),
                    )
                  ],
                )
              ],
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Daily Subscription",style:TextStyle(fontSize: 25,fontWeight: FontWeight.w500,color: green2),),
                    Divider(
                      thickness: 2,
                    ...
                    Row(
                      children: [
                        Column(
                          children: [
                            Text("Morning",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: green2),),
                            Container(
                              decoration: BoxDecoration(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${_morningWeights[index]} Kg",style: kgT,
                                  ),
                                  InkWell(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "${_eveningWeights[index]} Kg",style: kgT,
                                  ),
                                  InkWell(
            ...
            InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>Subscription_Detail_Screen()));
              },
              child: Container(
                height: 50,
                ...
                child: Center(child: Text("Custom Subscription",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w400,color: green2),)),
              ),
            ),
            SizedBox(height: 10,),
            Container(
              ...
              child: Center(child: Text("Save",style: TextStyle(fontSize: 22,fontWeight: FontWeight.w700,color: green2),)),
            ),
            SizedBox(height: 20,),
          ],
        );
